    ...
    <>
      <div className="bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col h-full transition duration-500 transform border border-gray-800 group hover:scale-[1.03] hover:shadow-orange-900/40">
        ...
        <div className="p-5 flex flex-col grow">
          ...
          {cartItem ? (
            <div className="max-auto w-full flex items-center justify-between bg-orange-600 rounded-full shadow-lg shadow-orange-800/50 p-1">
              <button
                onClick={() => removeFromCart(product.id)}
                className="w-10 h-10 flex items-center justify-center text-white hover:bg-orange-700 rounded-full transition"
              >
